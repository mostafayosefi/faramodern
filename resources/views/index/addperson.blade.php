...
@section('title')
	...
	<title>{{Session::get('mngindexs')->ind_ftitile}} | پیش ثبت نام حقیقی</title> 
<style type="text/css">
img.wp-smiley,
img.emoji {
...
<?php echo $txtdes->txt_des; ?>
			...
			<div class="rt-heading-wrapper style-3 text-center">
						<H2 class="   rt-heading style-3" >پیش ثبت نام حقیقی</H2>
					</div>		</div>
				</div>
...
<form class="elementor-form"  enctype="multipart/form-data"  method="post" action="{{env('APP_URL')}}/user/addperson"  > 
...
<input size="1" type="text" name="name" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام" required="required" value="{{old('name')}}" aria-required="true"> 
</div>
...
<input size="1" type="text" name="family" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام خانوادگی" required="required" value="{{old('family')}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
 <label>نام و نام خانوادگی (انگلیسی) </label>
 
<input size="1" type="text" name="nameeng" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام و نام خانوادگی (انگلیسی) "   value="{{old('nameeng')}}" aria-required="true"> 
</div>
</div>  
...
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25">  
 ...
 <label>نام پدر</label>
<input size="1" type="text" name="father" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام پدر"   value="{{old('father')}}" aria-required="true"> 
</div>
...
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
 <span style="color: red;" id="check">*</span><label  >کدملی</label> <span style="color: red;" id="message" ></span>
<input size="1" type="text" name="codmel"  id="box1"   class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="کدملی   " oninput="calculatec()"    maxlength="10" required=""  value="{{old('codmel')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="shnum" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="شماره شناسنامه"  value="{{old('shnum')}}" aria-required="true"> 
</div> 
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
 <label>محل صدور</label>
<input size="1" type="text" name="sodor" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="محل صدور   "  value="{{old('sodor')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="tellreq" id="tellreq" class="elementor-field elementor-size-sm  elementor-field-textual"   placeholder="شماره تلفن درخواستی"   required="required"   maxlength="4" onmouseover="myFunction(this, 'red')"  onclick="myFunction(this, 'red')"  value="{{old('tellreq')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="codp" id="codp" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="کدپستی محل" maxlength="10"   oninput="calculatep()"   value="{{old('codp')}}" aria-required="true"> 
</div>
