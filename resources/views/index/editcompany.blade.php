...
@section('title')
	...
	<title>{{Session::get('mngindexs')->ind_ftitile}} | ویرایش پیش ثبت نام حقوقی</title> 
<style type="text/css">
img.wp-smiley,
img.emoji {
...
<?php echo $txtdes->txt_des; ?>
			...
			<div class="rt-heading-wrapper style-3 text-center">
						<H2 class="   rt-heading style-3" >ویرایش پیش ثبت نام حقوقی</H2>
					</div>		</div>
				</div>
...
<form class="elementor-form"  enctype="multipart/form-data"  method="post" action="{{env('APP_URL')}}/user/mngreqcompany/edit/{{$requests->regc_id}}"  > 
...
<input size="1" type="text" name="namecompany" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام شرکت" required="required" value="{{$requests->regc_namecompany}}" aria-required="true"> 
</div>
...
<input size="1" type="text" name="namecompanyeng" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام شرکت انگلیسی" required="required" value="{{$requests->regc_namecompanyeng}}" aria-required="true"> 
</div>
...
<input size="1" type="text" name="numsabt" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="شماره ثبت" required="required" value="{{$requests->regc_numsabt}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
...
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
  <label>محل ثبت</label>
<input size="1" type="text" name="locsabt" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="محل ثبت   "   value="{{$requests->regc_locsabt}}" aria-required="true"> 
</div>
</div>  
...
<input size="1" type="text" name="codfin" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="کد اقتصادی" required="required" value="{{$requests->regc_codfin}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
  <span  style="color: red;" >*&nbsp;</span><label>شناسه ملی</label>
<input size="1" type="text" name="shemel" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="شناسه ملی" required="required" value="{{$requests->regc_shemel}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-40 elementor-field-required"></div>
...
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
  <label>تلفن</label>
<input size="1" type="text" name="tell" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="تلفن"  value="{{$requests->regc_tell}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
  <label>ایمیل</label>
<input size="1" type="email" name="email" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="ایمیل   "  value="{{$requests->regc_email}}" aria-required="true"> 
</div>
...
<input size="1" type="text" name="tellreq"  required="required"   maxlength="4"  id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual"   placeholder="شماره تلفن درخواستی"  value="{{$requests->regc_tellreq}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="codp" id="codp"   class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="کدپستی محل"  oninput="calculatep()"   value="{{$requests->regc_codp}}" aria-required="true"> 
</div>

<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-60"> 
 <label>آدرس محل</label>
<input size="1" type="text" name="adres" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="آدرس محل"  value="{{$requests->regc_adres}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="namemodir" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام مدیرعامل"  value="{{$requests->regc_namemodir}}" aria-required="true"> 
</div>

<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-60">
 <label>زمینه فعالیت</label> 
<input size="1" type="text" name="desactive" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="زمینه فعالیت"  value="{{$requests->regc_desactive}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="namerabet" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام رابط" required="required" value="{{$requests->regc_namerabet}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
   <span  style="color: red;" >*&nbsp;</span><label>نام خانوادگی رابط</label>
<input size="1" type="text" name="familyrabet" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام خانوادگی رابط" required="required" value="{{$requests->regc_familyrabet}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
  <label>نام و نام خانوادگی رابط (انگلیسی) </label>
<input size="1" type="text" name="namerabeteng" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام و نام خانوادگی رابط (انگلیسی) "   value="{{$requests->regc_namerabeteng}}" aria-required="true"> 
</div>
</div>  
...
<input size="1" type="text" name="fatherrabet" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام پدر رابط"   value="{{$requests->regc_fatherrabet}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
   <span  style="color: red;" >*&nbsp;</span><label>سمت رابط</label>
<input size="1" type="text" name="semat" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="سمت رابط" required="required" value="{{$requests->regc_semat}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-40 elementor-field-required"></div>
</div>
...
<input size="1" type="text" name="mobile" id="phoneNo" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="09" required="required"  value="{{$requests->regc_mobile}}"  aria-required="true"        oninput="calculatectell()"     > 
</div>
...
<input size="1" type="text" name="countryrabet" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="ملیت رابط" required="required" value="{{$requests->regc_countryrabet}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
 <span id="check" style="color: red;" >*</span><label  >کدملی رابط</label> <span style="color: red;" id="message" ></span>
<input size="1" type="text" name="codmel"  id="box1"  class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="کدملی رابط" required="required"  oninput="calculatec()"  value="{{$requests->regc_codmel}}" aria-required="true"> 
</div>
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-10 elementor-field-required"></div>
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-25"> 
  <label>شماره شناسنامه رابط   </label>
<input size="1" type="text" name="shosherabet" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="شماره شناسنامه رابط   "   value="{{$requests->regc_shosherabet}}" aria-required="true"> 
</div>
</div>  
...
<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-100"> 
 <label>توضیحات</label>
<input size="1" type="text" name="des" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="توضیحات"  value="{{$requests->regc_des}}" aria-required="true"> 
</div> 
