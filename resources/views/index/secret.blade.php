...
@section('title')
	...
	<title>{{Session::get('mngindexs')->ind_ftitile}} | تغییر رمز عبور</title> 
<style type="text/css">
img.wp-smiley,
img.emoji {
...
<div id="main-content">
	...
	<path class="elementor-shape-fill" d="M766.1,28.9c-200-57.5-266,65.5-395.1,19.5C242,1.8,242,5.4,184.8,20.6C128,35.8,132.3,44.9,89.9,52.5C28.6,63.7,0,0,0,0 h1000c0,0-9.9,40.9-83.6,48.1S829.6,47,766.1,28.9z"/>
			...
			<div class="rt-heading-wrapper style-3 text-center">
						<H2 class="   rt-heading style-3" >تغییر رمز عبور</H2>
					</div>		</div>
				</div>
...
<form class="elementor-form"  enctype="multipart/form-data"  method="post" action="{{env('APP_URL')}}/user/secret"  > 
...
<input size="1" type="password" name="nowpass" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual"   required="required"   aria-required="true"> 
</div>
...
<input size="1" type="password" name="userpassword" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual"  required="required"   aria-required="true"> 
</div>
...
<input size="1" type="password" name="userpassword_confirmation" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual"  required="required"   aria-required="true"> 
</div>
...
<span class="elementor-button-text">ویرایش رمزعبور</span>
</span>
</button></div> 
</div>
</div> 
