...
@section('title')
	...
	<title>{{Session::get('mngindexs')->ind_ftitile}} | تنظیمات پیش فرض فرم حقوقی</title> 
<style type="text/css">
img.wp-smiley,
img.emoji {
...
<div id="main-content">
			...
			<div class="rt-heading-wrapper text-center">
						<H1 class="   rt-heading custom-color" >تنظیمات پیش فرض فرم حقوقی  {{Session::get('mngindexs')->ind_ftitile}} </H1>
					</div>		</div>
				</div>
						</div>
					</div>
...
<?php echo $txtdes->txt_des; ?>
			...
			<div class="rt-heading-wrapper style-3 text-center">
						<H2 class="   rt-heading style-3" >تنظیمات پیش فرض فرم حقوقی</H2>
					</div>		</div>
				</div>
...
<form class="elementor-form"  enctype="multipart/form-data"  method="post" action="{{env('APP_URL')}}/user/default/company"  > 
