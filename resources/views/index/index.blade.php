...
<?php echo $spotlite->spotlite_des; ?>
...
@if (Session::has('signuser')) 
			...
			<a href="{{env('APP_URL')}}/user/myrequest/add" class="elementor-button-link elementor-button elementor-size-sm" role="button">
  ...
  @else  
				...
				<div class="elementor-widget-container">
					<div class="elementor-button-wrapper">
			<a href="{{env('APP_URL')}}/register" class="elementor-button-link elementor-button elementor-size-sm" role="button">
						<span class="elementor-button-content-wrapper">
				...
				<div class="elementor-widget-container">
					<div class="elementor-button-wrapper">
			<a href="{{env('APP_URL')}}/login" class="elementor-button-link elementor-button elementor-size-sm" role="button">
						<span class="elementor-button-content-wrapper">
...
@endforeach	 
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<h2 class="elementor-heading-title elementor-size-medium">خدمات و سرویس های ما </h2>		</div>
				</div>
 <?php $nbook=3; $mod=0; ?>		
@foreach($comidsfirst as $comid)

<?php $mod=fmod($nbook, 3); ?>
 ...
 @endif
			...
			<i aria-hidden="true" class="fa {{$comid->comid_icon}}"></i>			</div>
		</div>
				</div>
				</div>
			...
			<div class="rt-heading-wrapper text-center">
						<a href="#" target="_self"><h2 class="   rt-heading">{{$comid->comid_tit}}</h2></a>
					</div>		</div>
				</div>
				...
				<div class="elementor-widget-container">
					<div class="elementor-button-wrapper">
			<a href="{{$comid->comid_link}}" class="elementor-button-link elementor-button elementor-size-sm" role="button">
						<span class="elementor-button-content-wrapper">
						<span class="elementor-button-text">{{$comid->comid_btn}}</span>
		</span>
					</a>
		</div>
				</div>
...
@endif		
 ...
 <?php $nbook=5; $mod=0; ?>		
@foreach($comidssec as $comid)

<?php $mod=fmod($nbook, 5); ?>
...
<div class="elementor-row">
 @endif
			...
			<div class="elementor-column-wrap elementor-element-populated">
				...
				<div class="elementor-widget-container">
			<div class="elementor-image-box-wrapper"><figure class="elementor-image-box-img"><img width="128" height="128" src="{{env('APP_URL')}}/public/images/{{$comid->comid_img}}" class="elementor-animation-float attachment-full size-full lazyloaded" alt="{{$comid->comid_tit}}" data-ll-status="loaded"><noscript><img width="128" height="128" src="{{env('APP_URL')}}/public/images/{{$comid->comid_img}}" class="elementor-animation-float attachment-full size-full" alt="{{$comid->comid_tit}}" /></noscript></figure><div class="elementor-image-box-content"><h3 class="elementor-image-box-title">{{$comid->comid_tit}}</h3></div></div>		</div>
				</div>
						</div>
					</div>
		</div> 
...
@endforeach	 
			...
			<h2 class="elementor-heading-title elementor-size-medium">مشتریان ما چه می‌گویند؟</h2>		</div>
				...
				<div id="testimonial-dynamicID-520966" class="rt-carousel carousel-holder testimonial-carousel testimonials center boxed-carousel rt_lightbox_gallery" data-item-width="3" data-nav="true" data-dots="" data-margin="15" data-autoplay="" data-timeout="" data-thumbnails="false" data-boxed="true" data-min-height="" data-padding="0" data-loop="true" data-tablet-item-width="" data-mobile-item-width="">
					<div class="owl-carousel">


@foreach($comidsthi as $comid)
<div class="boxed">
...
<h6>{{$comid->comid_tit}} </h6>
<span>{{$comid->comid_icon}} </span>	
</div>
</div>
</div>
@endforeach
...
<form class="elementor-form" action="{{env('APP_URL')}}/contact" method="post"  >
...
<input size="1" type="text" name="namefamily" id="form-field-name" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="نام و نام خانوادگی" required="required" aria-required="true">	
</div>

<div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-100">
<input size="1" type="email" name="email" id="form-field-email" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="ایمیل">				
</div>

<div class="elementor-field-type-tel elementor-field-group elementor-column elementor-field-group-tel elementor-col-100 elementor-field-required">
<input size="1" type="tel" name="tell" id="form-field-tel" class="elementor-field elementor-size-sm  elementor-field-textual" placeholder="شماره تماس" required="required" aria-required="true" pattern="[0-9()#&amp;+*-=.]+" title="Only numbers and phone characters (#, -, *, etc) are accepted.">				
</div>


<div class="elementor-field-type-textarea elementor-field-group elementor-column elementor-field-group-message elementor-col-100 elementor-field-required">
<textarea class="elementor-field-textual elementor-field  elementor-size-sm" name="des" id="form-field-message" rows="4" placeholder="پیام شما" required="required" aria-required="true"></textarea>
</div>
...
<div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-name elementor-col-40 elementor-field-required" style="padding-bottom: 20px;">
