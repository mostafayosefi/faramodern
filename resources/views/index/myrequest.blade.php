...
@if($stat=='add')
<?php $tit='پیش ثبت نام'; $link1='addperson';  $link2='addcompany'; ?>
@elseif($stat=='mng')
 <?php $tit='مدیریت درخواستها';  $link1='mngreqperson/user';  $link2='mngreqperson/company';  ?>
@endif
...
@endif
	...
	<title>{{Session::get('mngindexs')->ind_ftitile}} | {{$tit}}</title> 
<style type="text/css">
img.wp-smiley,
img.emoji {
...
<div class="elementor-element elementor-element-3dad55e elementor-widget elementor-widget-heading" data-id="3dad55e" data-element_type="widget" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h2 class="elementor-heading-title elementor-size-default">  {{$tit}} حقیقی  </h2>	
</div></div></div></a>
...
<div class="elementor-element elementor-element-3dad55e elementor-widget elementor-widget-heading" data-id="3dad55e" data-element_type="widget" data-widget_type="heading.default">
<div class="elementor-widget-container">
<h2 class="elementor-heading-title elementor-size-default">  {{$tit}} حقوقی  </h2>	
</div></div></div></a>
