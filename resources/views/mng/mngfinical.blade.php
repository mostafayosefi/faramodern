...
<input type="text" class="form-control" id="exampleInputUsername1"   pattern="\d+"  autocomplete="off" placeholder="به درصد" name="ind_bis"  value="{{$mngindexs->ind_bis}}"  required > 
 ...
 <div class="form-group">
 <h4 class="card-title"> حداقل موجودی بازاریاب جهت درخواست تسویه (به ریال)</h4>
<input type="text" class="form-control" id="exampleInputUsername1"   pattern="\d+"  autocomplete="off" placeholder="به ریال" name="ind_bislimit"  value="{{$mngindexs->ind_bislimit}}"  required > 
 </div>
