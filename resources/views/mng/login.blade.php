...
<head>
  ...
  <title>مدیریت سیستم فروش شماره  </title>
  <!-- core:css -->
...
<body class="sidebar-dark rtl">
 ...
 <a href="{{env('APP_URL')}}/" class="noble-ui-logo d-block mb-2">مدیریت <span>سیستم فروش شماره</span></a>
                    <h5 class="text-muted font-weight-normal mb-4">خوش آمدید! به حساب کاربری خود وارد شوید</h5>
                    <form   action="{{env('APP_URL')}}/superadmin/sign-in"  method="post"  data-toggle="validator" class="forms-sample  ">
