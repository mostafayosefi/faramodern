...
<form class="elementor-form"  enctype="multipart/form-data"  method="post" action="{{env('APP_URL')}}/superadmin/addcompany"  > 

 

 <div class="card-header card-header-border-bottom">
 <h4>ثبت درخواست حقوقی</h4>
 </div>
...
<input size="1" type="text" name="namecompany" id="form-field-name"  class="form-control"  placeholder="نام شرکت" required="required" value="{{old('namecompany')}}" aria-required="true"> 
</div>

<div class="form-group"> 
  <span  style="color: red;" >*&nbsp;</span><label>نام شرکت (En)  </label>
<input size="1" type="text" name="namecompanyeng" id="form-field-name"  class="form-control"  placeholder="نام شرکت انگلیسی" required="required" value="{{old('namecompanyeng')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="numsabt" id="form-field-name"  class="form-control"  placeholder="شماره ثبت" required="required" value="{{old('numsabt')}}" aria-required="true"> 
</div>
...
<div class="form-group"> 
  <label>محل ثبت</label>
<input size="1" type="text" name="locsabt" id="form-field-name"  class="form-control"  placeholder="محل ثبت   "   value="{{old('locsabt')}}" aria-required="true"> 
</div>  
...
<input size="1" type="text" name="codfin" id="form-field-name"  class="form-control"  placeholder="کد اقتصادی" required="required" value="{{old('codfin')}}" aria-required="true"> 
</div>

<div class="form-group"> 
  <span  style="color: red;" >*&nbsp;</span><label>شناسه ملی</label>
<input size="1" type="text" name="shemel" id="form-field-name"  class="form-control"  placeholder="شناسه ملی" required="required" value="{{old('shemel')}}" aria-required="true"> 
</div> 
...
<input type="file" name="file"     placeholder="اپلود مدارک"    data-maxsize="5" data-maxsize-message="This file exceeds the maximum allowed size.">				
</div>
...
<input size="1" type="text" name="codp" id="codp"   class="form-control"  placeholder="کدپستی محل"  oninput="calculatep()"    value="{{old('codp')}}" aria-required="true"> 
</div>
...
<input size="1" type="text" name="namemodir" id="form-field-name"  class="form-control"  placeholder="نام مدیرعامل"  value="{{old('namemodir')}}" aria-required="true"> 
</div>


<div class="form-group">
 <label>زمینه فعالیت</label> 
<input size="1" type="text" name="desactive" id="form-field-name"  class="form-control"  placeholder="زمینه فعالیت"  value="{{old('desactive')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="namerabet" id="form-field-name"  class="form-control"  placeholder="نام رابط" required="required" value="{{old('namerabet')}}" aria-required="true"> 
</div>

<div class="form-group"> 
  <span  style="color: red;" >*&nbsp;</span><label>نام خانوادگی رابط</label>
<input size="1" type="text" name="familyrabet" id="form-field-name"  class="form-control"  placeholder="نام خانوادگی رابط" required="required" value="{{old('familyrabet')}}" aria-required="true"> 
</div>

<div class="form-group"> 
  <label>نام و نام خانوادگی رابط (انگلیسی) </label>
<input size="1" type="text" name="namerabeteng" id="form-field-name"  class="form-control"  placeholder="نام و نام خانوادگی رابط (انگلیسی) "   value="{{old('namerabeteng')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="fatherrabet" id="form-field-name"  class="form-control"  placeholder="نام پدر رابط"   value="{{old('fatherrabet')}}" aria-required="true"> 
</div>

<div class="form-group"> 
  <span  style="color: red;" >*&nbsp;</span><label>سمت رابط</label>
<input size="1" type="text" name="semat" id="form-field-name"  class="form-control"  placeholder="سمت رابط" required="required" value="{{old('semat')}}" aria-required="true"> 
</div> 
...
<input size="1" type="text" name="countryrabet" id="form-field-name"  class="form-control"  placeholder="ملیت رابط" required="required" value="{{old('countryrabet')}}" aria-required="true"> 
</div>

<div class="form-group"> 
 <span id="check" style="color: red;" >*</span><label  >کدملی رابط</label> <span style="color: red;" id="message" ></span>
<input size="1" type="text" name="codmel"  id="box1"   class="form-control"  placeholder="کدملی رابط" required="required"  oninput="calculatec()"  value="{{old('codmel')}}" aria-required="true"> 
</div>

<div class="form-group"> 
  <label>شماره شناسنامه رابط   </label>
<input size="1" type="text" name="shosherabet" id="form-field-name"  class="form-control"  placeholder="شماره شناسنامه رابط   "   value="{{old('shosherabet')}}" aria-required="true"> 
</div> 
