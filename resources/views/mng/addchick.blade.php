...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="نام مرغ" name="name"  value="{{ old('name') }}"  required > 
</div>	

	
<div class="form-group" >
<label for="exampleInputUsername1">قیمت مرغ</label>
<input type="number" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="قیمت مرغ" name="price"  value="{{ old('price') }}"  required > 
</div>	

<div class="form-group" >
<label for="exampleInputUsername1">تعداد تخم گذاری در هر ساعت</label>
<input type="number" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="تعداد تخم گذاری در هر ساعت" name="eggperhour"  value="{{ old('eggperhour') }}"  required > 
</div>	
