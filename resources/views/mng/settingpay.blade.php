...
<div class="form-group">
										<div class="form-check">
											<label class="form-check-label">
												<input type="radio" class="form-check-input" name="namesetingpay" id="optionsRadios" value="1" @if($mngindexs->ind_settingpay=='1')  checked @endif  >
											درگاه پرداخت آنلاین
											<i class="input-frame"></i></label>
										</div>
										<div class="form-check">
											<label class="form-check-label">
												<input type="radio" class="form-check-input" name="namesetingpay" id="optionsRadios1" value="2" @if($mngindexs->ind_settingpay=='2')  checked @endif >
											پرداخت دستی
											<i class="input-frame"></i></label>
										</div>
