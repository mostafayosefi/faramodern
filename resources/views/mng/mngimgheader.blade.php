...
<label for="ind_headermobile"> فاو آیکون سایت</label>  
<input type="file"     id="ind_headermobile" autocomplete="off"  name="ind_headermobile" > 
<br>
<span style="color: #3edcf2"> فاو آیکون سایت</span>
</div>		
 

<img src="{{env('APP_URL')}}/public/images/{{$mngindexs->ind_headermobile}}" height="70px" width="120px"   />
...
<br>
<span style="color: #3edcf2"> ابعاد تصویر پیشنهادی w80 * h30</span>
</div>	 
<img src="{{env('APP_URL')}}/public/images/{{$mngindexs->ind_himglog}}"  height="150px" width="250px"    />
