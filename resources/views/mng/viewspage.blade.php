      ...
      <div class="page-content">
        ...
        <nav class="page-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">مشاهده {{$namepages}}  </li>
          </ol>
        </nav>
        ...
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">لیست {{$namepages}}  </h6>
...
<label for="exampleInputUsername1">عنوان {{$namepage}}  </label>
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="عنوان صفحه" name="name"   value="{{$admin->page_name}}"   required> 
 ...
 <div class="form-group">
 <h4 class="card-title">  متن خبر {{$namepage}} </h4>
