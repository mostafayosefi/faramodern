...
@section('body')
 ...
 <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/superadmin/dashboard">داشبورد </a></li>
            <li class="breadcrumb-item active" aria-current="page">ویرایش کیف پول</li>
          </ol>
        </nav>
...
<br>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">ویرایش کیف پول </h4>
...
@endif
 ...
 <input  name="name" type="text" class="form-control"   value="{{$admins->wallet_name}}" required>
 </div>
 
 <div class="form-group  col-lg-11">
 <label for="input-mask">آیدی کیف پول</label> 
 <input  name="secret" type="text" class="form-control"  value="{{$admins->wallet_idsecret}}" required>
 </div>
...
<img height="110px" width="110px"  src="{{env('APP_URL')}}/qr2/php-qrcode-main/phpqrcode/temp/{{$admins->wallet_qrcode}}"/>
   

<hr>

<img height="110px" width="110px"  src="{{env('APP_URL')}}/public/images/{{$admins->wallet_logo}}"/>
