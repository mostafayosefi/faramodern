...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="عنوان" disabled="" name="name"  value="{{$admin->des_name}}"  required > 
 </div>
 ...
 <div class="form-group">
 <h4 class="card-title"> متن توضیحات</h4>
 <textarea class="form-control" name="des"  id="tinymceExample" rows="10"  >{{$admin->des_des}}</textarea>
 </div>
