...
@section('body')
 ...
 <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/superadmin/mngqst">مدیریت پرسش و پاسخ</a></li>
...
<label for="soa">سوال</label>
<input type="text" class="form-control" id="soa" autocomplete="off" placeholder="سوال" name="soa"  value="{{$admins->qst_soa}}"  required > 
</div>	

	
<div class="form-group" >
<label for="pas"> پاسخ</label> 

<textarea class="form-control" id="pas" autocomplete="off" placeholder="پاسخ" name="pas"  rows="8"   required  >{{$admins->qst_pas}}</textarea>
