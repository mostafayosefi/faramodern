...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="اینستاگرام" name="instagram"  value="{{$mngindexs->instagram}}"    > 
 </div>
...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="فیسبوک" name="facebook"  value="{{$mngindexs->facebook}}"    > 
 </div>
 
 				
 <div class="form-group">
 <h4 class="card-title">توییتر </h4>
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="توییتر" name="twit"  value="{{$mngindexs->twitter}}"    > 
 </div>
 
 				
 <div class="form-group">
 <h4 class="card-title">یوتیوب </h4>
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="یوتیوب" name="youtube"  value="{{$mngindexs->youtube}}"    > 
 </div>
...
<input type="text" class="form-control" id="exampleInputUsername1" autocomplete="off"      placeholder="تلفن" name="tell"  value="{{$mngindexs->tell}}"    > 
 </div>
...
<input type="text"  class="form-control"  id="exampleInputUsername1"  autocomplete="off"   placeholder="ایمیل" name="email"  value="{{$mngindexs->email}}"    > 
 </div>
 ...
 <textarea class="form-control" name="ind_adres"  rows="6" required>{{$mngindexs->ind_adres}}</textarea>
</div>
 ...
 <textarea class="form-control" name="ind_analtik"  rows="3"  >{{$mngindexs->ind_analtik}}</textarea>
 </div>
  <hr>
 
 <div class="form-group">							
 <h4 class="card-title"> کد پشتیبانی </h4>
 <textarea class="form-control" name="ind_codetiket"  rows="5"  >{{$mngindexs->ind_codetiket}}</textarea>
 </div>
