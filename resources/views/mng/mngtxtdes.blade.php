...
@section('title')
<title>مدیریت متن های پیش فرض</title>
@stop
...
@section('body')
 ...
 <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/superadmin/dashboard">داشبورد مدیریت</a></li>
            <li class="breadcrumb-item active" aria-current="page">مدیریت متن های پیش فرض</li>
          </ol>
        </nav>
...
<td> {{$i++}} </td>   
 <td>  {{$admin->txt_tit}} </td> 
 <td>
<a href="{{env('APP_URL')}}/superadmin/mngtxtdes/edit/{{$admin->txt_id}}"  > 
